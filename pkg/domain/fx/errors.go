...
// ErrReferenceNotValid indicates that the account code is incorrect
...
// ErrExchange indicates that the number of sender charges is incorrect
...
// ErrRateNotValid indicates that the number of sender charges is incorrect
